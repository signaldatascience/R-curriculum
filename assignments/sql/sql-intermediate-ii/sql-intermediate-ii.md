...
You'll first learn how to convert data frames in R into SQLite tables. Afterward, you'll work through a series of themed problems involving `WITH` statements and various aggregation operators.
