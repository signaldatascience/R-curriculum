...
* Use your `arg_min(v)` function to help you concisely extract the rows of your results data frame corresponding to the minimal RMSE values for predicting Extraversion and Neuroticism. You should find values close to $(\alpha, \lambda) = (0.1, 0.2329952)$ for Extraversion and $(\alpha, \lambda) = (0.1, 0.3393222)$ for Neuroticism, although the folds used for cross-validation will be RNG-dependent and your results may be slightly different.
