...
* Write down the current time. Please email us (at `signaldatascience@gmail.com`) with your R script attached when you finish along with the amount of elapsed time.
...
* If it's 12:30 and you haven't finished: send us your code and go eat lunch! It's okay if you don't finish in the alloted time.
...
* **After 7 PM**, I'll give a short (30-minute) explanation of all three probability questions to anyone who sticks around
